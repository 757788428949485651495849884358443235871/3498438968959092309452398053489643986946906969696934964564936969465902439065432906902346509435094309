...
end)local gradient = game.CoreGui:WaitForChild("RobloxLoadingGui")
...
gradient:GetChildren()[1].BackgroundColor3 = Color3.new(1, 1, 1)
uigradient.Parent = gradient:GetChildren()[1]
